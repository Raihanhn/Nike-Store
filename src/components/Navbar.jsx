        ...
        <nav className="flex items-center justify-between nike-container">
            ...
            <ul className="flex items-center justify-center gap-2 ">
                <li className="grid items-center">
                   < AiOutlineSearch className={`icon-style ${navState && 'text-slate-900 transition-all duration-300'} `} />
                </li>
                <li className="grid items-center">
                ...
                <li className="border-none outline-none active:scale-110 transition-all duration-300 relative">
                    <button type='button' className='' > 
                      <HiOutlineShoppingBag className={`icon-style ${navState && 'text-slate-900 transition-all duration-300'} `} />
